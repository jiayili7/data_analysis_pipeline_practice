...
# count words
dats: results/isles.dat results/abyss.dat results/last.dat results/sierra.dat 
...
# plot
figs: results/figure/isles.png results/figure/abyss.png results/figure/last.png results/figure/sierra.png
